...
- Create and manage multiple tactic projects
- Add elements such as players, markers, and drawing lines
- Design passing sequences or tactical movements
- Choose from 3 different pitch templates
- Save finished tactics as images in the gallery


🛠️ Tech Stack

- Room DAO – For local data persistence
- Flow – For reactive data streams
- SurfaceView & SurfaceHolder – For custom canvas drawing
- Paint & Path – For visual drawing operations
- drawBitmap – For rendering pitch templates and player icons
